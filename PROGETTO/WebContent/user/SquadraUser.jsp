...
<div class="wrapper row1">
  <header id="header" class="clear">
    <div id="hgroup">
      <h1><a href="HomeLogged.jsp">La Squadra</a></h1>
        ...
        <article class="one_third">
          <figure><img src="/PROGETTO/images/rosa.jpg" width="290" height="180" alt="">
            <figcaption>
              ...
              <footer class="more"><a href="RosaUser.jsp">Read More &raquo;</a></footer>
            </figcaption>
          </figure>
        </article>
        <article class="one_third">
          <figure><img src="/PROGETTO/images/partite.jpg" width="290" height="180" alt="">
            <figcaption>
              ...
              <footer class="more"><a href="PartiteUser.jsp">Read More &raquo;</a></footer>
            </figcaption>
          </figure>
        </article>
        ...
        <article>
          <figure><img src="/PROGETTO/images/titolo-abbonamenti-usavellino.jpg" width="450" height="250" alt="">
            <figcaption>
              ...
              <footer class="more"><a href="AbbonamentiUser.jsp">Read More &raquo;</a></footer>
            </figcaption>
          </figure>
        </article>
      </section>
