...
<div class="wrapper row1">
  <header id="header" class="clear">
    <div id="hgroup">
      ...
      <h2>Il sito dedicato alla tua squadra del cuore iiiiiiiii</h2>
    </div>
    <nav>
      <ul>
        ...
        <li><a href="/PROGETTO/admin/StoriaAdmin.jsp">STORIA</a></li>
        ...
        <article class="one_third">
          <figure><img src="/PROGETTO/images/storia.jpg" width="290" height="180" alt="">
            <figcaption>
              ...
              <footer class="more"><a href="/PROGETTO/admin/StoriaAdmin.jsp">Read More &raquo;</a></footer>
            </figcaption>
          </figure>
        </article>
        <article class="one_third">
          <figure><img src="/PROGETTO/images/italia.jpg" width="290" height="180" alt="">
            <figcaption>
              <h2>LA ROSA</h2>
              <p>Tutti i membri dek team :D</p>
              <footer class="more"><a href="/PROGETTO/admin/SquadraAdmin.jsp">Read More &raquo;</a></footer>
            </figcaption>
          </figure>
        </article>
        ...
        <article>
          ...
          <img src="/PROGETTO/images/Logo_Serie_B_2014.png" width="150" height="50" style="width: 52px; height: 58px; ">
            <figcaption>
              ...
              <footer class="more"><a href="/PROGETTO/admin/AbbonamentiAdmin.jsp">Read More &raquo;</a></footer>
            </figcaption>
          </figure>
        </article>
      </section>
